...
| Approval Mode           | `general.defaultApprovalMode`      | The default approval mode for tool execution. 'default' prompts for approval, 'auto_edit' auto-approves edit tools, and 'plan' is read-only mode. 'yolo' is not supported yet. | `"default"` |
| Auto Update             | `general.enableAutoUpdate`         | Enable automatic updates.                                                                                                                                                      | `true`      |
...
| Tips                                 | `ui.tips`                              | Show helpful tips in the UI                                                                                                                                       | `true`   |
| Shortcuts Hint                       | `ui.showShortcutsHint`                 | Show the "? for shortcuts" hint above the input.                                                                                                                  | `true`   |
| Banner                               | `ui.banner`                            | Show the application banner                                                                                                                                       | `true`   |
| Context Summary                      | `ui.contextSummary`                    | Show the context summary (GEMINI.md, MCP servers) above the input.                                                                                                | `true`   |
| CWD                                  | `ui.footer.cwd`                        | Show the current working directory path in the footer.                                                                                                            | `true`   |
| Sandbox Status                       | `ui.footer.sandboxStatus`              | Show the sandbox status indicator in the footer.                                                                                                                  | `true`   |
| Model Info                           | `ui.footer.modelInfo`                  | Show the model name and context usage in the footer.                                                                                                              | `true`   |
| Context Window Percentage            | `ui.footer.contextPercentage`          | Shows the context window remaining percentage.                                                                                                                    | `false`  |
...
| Loop Detection        | `model.loopDetection`        | Enable automatic detection and prevention of infinite loops.                           | `true`  |
| Next Speaker Check    | `model.nextSpeakerCheck`     | Enable the next speaker check.                                                         | `false` |
...
| LLM Correction                   | `tools.llmCorrection`                | Enable LLM-based error correction for edit tools. When enabled, tools will attempt to self-correct if exact string matches are not found. | `false` |

### Security

| UI Label                         | Setting                                         | Description                                                                                                                                                               | Default |
| -------------------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| YOLO Mode                        | `security.yoloModeAllowed`                      | Allow YOLO mode to be used.                                                                                                                                               | `true`  |
...
| Git Extensions                   | `security.gitExtensionsEnabled`                 | Allow installing and loading extensions from Git.                                                                                                                         | `true`  |
| Extension Source Regex Allowlist | `security.allowedExtensions`                    | List of Regex patterns for allowed extensions. If nonempty, only extensions that match the patterns in this list are allowed. Overrides the gitExtensionsEnabled setting. | `[]`    |
