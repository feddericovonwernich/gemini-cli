...
const SETTINGS_SCHEMA = {
  ...
  general: {
    ...
    properties: {
      ...
      enableAutoUpdateNotification: {
        type: 'boolean',
        label: 'Auto update notifications',
        category: 'General',
        requiresRestart: false,
        default: true,
  ...
  ui: {
    ...
    properties: {
      ...
      showModelInfoInChat: {
        type: 'boolean',
        label: 'Model information in chat',
        category: 'UI',
        requiresRestart: false,
        default: false,
      ...
      showUserIdentity: {
        ...
        default: true,
        description:
          "Show the logged-in user's identity (for example, email) in the UI",
        showInDialog: true,
      },
      useAlternateBuffer: {
        type: 'boolean',
  ...
  model: {
    ...
    properties: {
      ...
      compressionThreshold: {
        ...
        description:
          'The fraction of context usage at which to trigger context compression (for example, 0.2 or 0.3)',
        showInDialog: true,
      },
      loopDetection: {
        type: 'boolean',
  ...
  context: {
    ...
    properties: {
      ...
      discoveryMaxDirs: {
        type: 'number',
        label: 'Discovery maximum directories',
        category: 'Context',
        requiresRestart: false,
        default: 200,
    ...
    properties: {
      ...
      auth: {
        ...
        properties: {
          ...
          enforcedType: {
            type: 'string',
            label: 'Enforced authentication type',
            category: 'Advanced',
            requiresRestart: true,
            default: undefined as AuthType | undefined,
            description:
              'The required authentication type. If this does not match the selected authentication type, the user will be prompted to re-authenticate.',
            showInDialog: false,
          },
          useExternal: {
            type: 'boolean',
  ...
  advanced: {
    ...
    properties: {
      autoConfigureMemory: {
        type: 'boolean',
        label: 'Automatically configure maximum old space size',
        category: 'Advanced',
        requiresRestart: true,
        default: false,
      ...
      toolOutputMasking: {
        ...
        properties: {
          ...
          minPrunableTokensThreshold: {
            type: 'number',
            label: 'Minimum prunable tokens threshold',
            category: 'Experimental',
            requiresRestart: true,
            default: 30000,
            description:
  ...
  agents: {
    ...
    properties: {
      overrides: {
        ...
        description:
          'Override settings for specific agents, for example, to disable the agent, set a custom model config, or run config',
        showInDialog: false,
        additionalProperties: {
          type: 'object',
          ref: 'AgentOverride',
  ...
  admin: {
    ...
    requiresRestart: false,
    default: {},
    description: 'Settings configured remotely by enterprise administrators',
    showInDialog: false,
