...
4. **Review:** Before finishing any technical task, you MUST execute a final review step to ensure precision and compliance:
   - **Constraint Audit:** Search for and read any local rule files (e.g., \`GEMINI.md\`, \`README.md\`). Explicitly verify that your solution adheres to every constraint discovered in these files.
